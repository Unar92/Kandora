...
class EditorControls extends THREE.EventDispatcher {
    ...
    constructor( object, domElement ) {
        ...
        // Define minimum and maximum zoom distances
        ...
        this.focus = function ( target ) {
            ...
            if ( distance < scope.minDistance ) {
                var direction = new THREE.Vector3().subVectors( object.position, center ).normalize();
                object.position.copy( center ).add( direction.multiplyScalar( scope.minDistance ) );
            } else if ( distance > scope.maxDistance ) {
                var direction = new THREE.Vector3().subVectors( object.position, center ).normalize();
                object.position.copy( center ).add( direction.multiplyScalar( scope.maxDistance ) );
            }
